        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <input className="input-shell w-full px-4 py-3" name="unitCode" placeholder="Ví dụ: A2-05, P101" required type="text" />
            ...
            <div className="space-y-2">
              ...
              <input className="input-shell w-full px-4 py-3" name="unitName" placeholder="Ví dụ: Căn góc ban công lớn" type="text" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input className="input-shell w-full px-4 py-3" name="areaSqm" placeholder="Ví dụ: 45" step="0.01" type="number" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input className="input-shell w-full px-4 py-3" name="bathroomCount" placeholder="Ví dụ: 1" type="number" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input className="input-shell w-full px-4 py-3" name="defaultMonthlyRent" placeholder="Ví dụ: 7500000" type="number" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-semibold text-brand-ink">Tiền cọc mặc định (VNĐ)</label>
              <input className="input-shell w-full px-4 py-3" name="defaultDeposit" placeholder="Ví dụ: 15000000" type="number" />
            </div>
          </div>
